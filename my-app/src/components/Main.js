                        ...
                        <div className="col-lg-6" data-aos="fade-up" data-aos-delay="250">
                            <div className="content ps-0 ps-lg-5">
                                ...
                                <ul>
                                    ...
                                    <li><i className="bi bi-check-circle-fill"></i> <span>We take pride in delivering quality that speaks for itself — with every product built to perform flawlessly and delight users at every touchpoint.</span></li>
                    ...
                    <div className="row gy-4">
                        ...
                        <div className="col-lg-3 col-md-6">
                            <div className="stats-item d-flex align-items-center w-100 h-100">
                                ...
                                <div>
                                    <span className="purecounter">551</span>
                                    <p>Projects</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-3 col-md-6">
                            <div className="stats-item d-flex align-items-center w-100 h-100">
                                ...
                                <div>
                                    <span className="purecounter">324</span>
